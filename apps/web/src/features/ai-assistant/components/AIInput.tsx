			...
			<div className="flex items-center gap-2">
				...
				{inputValue.trim() && (
					<button
						type="button"
						onClick={onSend}
						className="flex size-9 shrink-0 items-center justify-center rounded-full border border-accent-primary bg-surface text-accent-primary transition-all hover:bg-surface-hover"
