      ...
      <div className="flex flex-wrap items-center gap-4">
        <div className="flex items-center gap-4">
          <Link
            ...
            className="flex items-center gap-2 whitespace-nowrap rounded-lg border bg-fuchsia-100 hover:bg-fuchsia-900 hover:text-fuchsia-100 px-3 py-2.5 font-medium text-fuchsia-900 text-sm transition-colors"
          >
          ...
          {editable && (
            <Button
              variant="secondary"
              className="border border-gray-200 bg-lime-100 text-lime-900 text-sm hover:bg-lime-700 hover:text-lime-200 transition-colors px-3 py-2.5"
              onClick={() =>
