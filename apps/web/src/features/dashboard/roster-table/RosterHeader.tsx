			...
			<div className="flex flex-wrap items-center gap-4">
				<div className="flex items-center gap-4">
					<Link
						...
						className="flex items-center gap-2 whitespace-nowrap rounded-lg border bg-fuchsia-100 px-3 py-2.5 font-medium text-fuchsia-900 text-sm transition-colors hover:bg-gray-200"
					>
